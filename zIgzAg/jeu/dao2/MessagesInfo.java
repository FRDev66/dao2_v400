...
public class MessagesInfo extends MessagesAbstraits{
 ...
 public static final String MAIL_CORPS_RAPPORT="Bonjour,je suis une IA qui répond au doux nom de KZPGO.\n\nAttention, les images nécessaires au rapport ne sont fournies que lors du premier tour. Si vous avez effacé vos images nécessaires pour visualiser votre rapport avec les images, vous pouvez télécharger le fichier images.zip à cette adresse :  http://millesroyaumes.fr/dao2/download/images.zip et les dézipper dans le même répertoire dans lequel vous dézippez le rapport. \n\n Rappel Dark Age of Orion:  "+Chemin.RACINE_SITE+" .\n\nVotre rapport se trouve ici : {2} \n\nVous aurez besoin de:\n  1)votre login: {0}\n  2)votre mot de passe: {1}\n\n Conservez les précieusement!\n\n           (....) \n\n Humm... Un autre évènement requiert mon attention et je dois vous quitter, momentanément!\n\n Ah oui! Si vous voulez pour une raison ou une autre vous désinscrire, allez sur la page "+Chemin.SITE_REGISTRE+" .\n\nA bientôt et bonne chance!\n\nKZPGO";
 //public static final String MAIL_CORPS_RAPPORT="Bonjour,je suis une IA qui répond au doux nom de KZPGO.\n\nAttention, les images nécessaires au rapport ne sont fournies que lors du premier tour. Si vous avez effacé vos images nécessaires pour visualiser votre rapport avec les images, vous pouvez les téléchargez à cette adresse :  http://dao2.free.fr/telechargement/images.zip et les dézipper dans le même répertoire dans lequel vous dézippez le rapport. \n\n Rappel Dark Age of Orion:  "+Chemin.RACINE_SITE+" .\n\nVotre rapport se trouve ici : {2} \n\nVous aurez besoin de:\n  1)votre login: {0}\n  2)votre mot de passe: {1}\n\n Conservez les précieusement!\n\n      Si vous désirez voir les statistiques du tour, allez à cette adresse: http://dao2forum.free.fr/stats/stats.htm\n     Vous pouvez aussi les télécharger ici: http://dao2forum.free.fr/stats/stats16.zip\n\n         (....) \n\n Humm... Un autre évènement requiert mon attention et je dois vous quitter, momentanément!\n\n       Il est possible que le site soit obligé d'être déplacer suite au problème actuel, je vous préviendrai si tel était le cas.\n\n    Ah oui! Si vous voulez pour une raison ou une autre vous désinscrire, allez sur la page "+Chemin.SITE_REGISTRE+" .\n\nA bientôt et bonne chance!\n\nKZPGO";
 //public static final String MAIL_CORPS_RAPPORT="Bonjour,je suis une IA nommée Grand Ordonnateur, je suis le système informatique gérant toutes les transactions économiques et toutes les communications à travers la Galaxie d'Orion.\n\nCe message s'adresse à tous les dirigeants de la Galaxie. \n\n Rappel Dark Age of Orion:  "+Chemin.RACINE_SITE+" .\n\nVotre rapport se trouve ici : {2} \n\nVous aurez besoin de:\n  1)votre login: {0}\n  2)votre mot de passe: {1}\n\n Conservez les précieusement!\n\n      Si vous désirez voir les statistiques du tour, allez à cette adresse: http://dao2forum.free.fr/stats/stats.htm    \n\n         (....) \n\n Humm... Un autre évènement requiert mon attention et je dois vous quitter, momentanément!\n\n Suite aux derniers problèmes de communications et d'informatique qui ont eu lieu dernièrement, mes concepteurs ont effectué de nombreux changements dans mon programme original. UNe nouvelle console d'Ordres a été mise en place, elle sera opérationnelle dès ce Lundi (dans la matinée) et le tour est repoussé de quelques jours. Pour en savoir d'avantage vous trouverez un message à cette adresse : http://dao2forum.free.fr/phpBB2/viewtopic.php?t=355      \n\n    Ah oui! Si vous voulez pour une raison ou une autre vous désinscrire, allez sur la page "+Chemin.SITE_REGISTRE+" .\n\nA bientôt et bonne chance!\n\nGrand Ordonnateur";
 ...
 public static final String HEROS_MORT_0002="Le lieutenant {0} du commandant {1} vient trouver la mort lors d'un combat épique.";
 ...
 public static final String EVENEMENT_0000_0=
  "Le fond d'aide aux déshérités de la <i>Banque Orionaise de Crédit</i> vous vient en aide. Vous recevez {0} centaures.";
 public static final String EVENEMENT_0000_1=
  "La <i>Fondation Romus et Remulus</i> a décidé d'intervenir en votre faveur. Vous recevez {0} centaures.";
 public static final String EVENEMENT_0000_2=
  "Une de vos flottes de surveillance vient d'intercepter une flotte pirate. Elle vous rapporte le butin qu'elle a pu récupérer. Vous recevez {0} centaures.";
 public static final String EVENEMENT_0000_3=
  "Erreur de la Banque en votre faveur ! Vous recevez {0} centaures.";
 public static final String EVENEMENT_0000_4="Votre compte bancaire vient d'être modifié par l'intervention de la Banque Orionnaise. Vous venez d'être débité de {0} centaures.";


  //Messages concernant les apports financiers des Héros
 public static final String EVENEMENT_0001_0=
  "Les négociations avec une Corporation commerciale ont abouti grâce à l'intervention de {0}. Vous recevez {1} centaures.";
 public static final String EVENEMENT_0001_1=
  "{0} a négocié une transaction commerciale en votre faveur. Vous recevez {1} centaures.";
 public static final String EVENEMENT_0001_2=
  "{0} a effectué une transaction commerciale en votre faveur. Vous recevez {1} centaures."; 
 ...
 public static final String EVENEMENT_POPULATION_POSITIF_4=
  "L'équipe de BloodBowl de la planète {1} de votre système {0} vient de remporter une match trés important pour la suite du championnat. Les habitants heureux sont dans les rues, tout le monde s'embrasse, s'enlace,.... La population de la planète augmente de {2} millions.";
 public static final String EVENEMENT_POPULATION_POSITIF_5=
  "Votre politique de créateur de crèches sur la planète {1} de votre système {0} remporte un franc succés. La population envisage enfin un avenir pour ses enfants. Les naissances augmentent de {2} millions.";
 ...
 public static final String EVENEMENT_POPULATION_NEGATIF_4=
  "Un treblement de terre vient de dévaster la planète {1} de votre système {0} juste dans le point de trés forte densité. De nombreuse victimes sont à déplorées. La population de la planète diminue de {2} millions.";
 public static final String EVENEMENT_POPULATION_NEGATIF_5=
  "Un virus étudié en laboratoire vient de se répendre à la surface la planète {1} de votre système {0}. Malgré l'état d'alerte et l'évacuation rapide des lieux dangereux, la population a été gravement touché dans les premières heures, elle diminue de {2} millions.";
...
public static final String ER_COMMANDANT_VENTE_MARCHANDISE_0002=
 ...
 public static final String ER_COMMANDANT_ACHAT_MARCHANDISE_0000=
   "Vous ne pouvez vendre {2} marchandise(s) de type {0} sur le système {1} : la Banque Orionaise de Crédit bloque la transaction, les fonds du commandant acheteur étant insuffisants.";
 ...
 public static final String EV_COMMANDANT_GESTION_FLOTTE_0005=
   "Votre flotte {0} vient de détecter en {1} une ancienne porte intra-galactique. Vers ou mène elle? Mystère. Par contre, le passage est visiblement payant...";
...
"Vous venez de capturer la flotte numéro {1} du commandant {0}."; 
public static final String ER_COMMANDANT_CAPTURE_FLOTTE_0000=
"Impossible de capturer votre flotte {0} au commandant numéro {1}";
