...
import zIgzAg.html.BaliseHTML;
 ...
 public class Position implements Serializable,Comparable,Cloneable{
  ...
  public int hashCode(){
   return (galaxie*Const.BORNE_MAX*Const.BORNE_MAX+pos[0]*Const.BORNE_MAX+pos[1]);
   }
...
/*  public int hashCode(){
  ...
  public static Position deplacementVers(Position depart,Position arrivee,int deplacement){
