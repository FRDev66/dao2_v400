...
public interface Const{
 ...
 //diverses caract�ristiques internet.

 public static final int NB_GALAXIES=Messages.NOMS_GALAXIES.length;

 public static final int BORNE_MAX=140;
  // Les bornes pour chaque galaxie(multiple de 20 de preference).Les coordonn�es vont de 1 � BORNE_MAX.
...
// public static final int NB_PORTES=5;
 ...
 //Le nombre maximal de plan�tes par syst�me.

// public static final int[][] PASSAGES_GALACTIQUES={{3,3},{50,50},{3,98},{98,98},{98,3}};
  // localisation des portes galactiques.

 public static final int[][] PORTES={{0,30,30,95,65},{0,90,90,45,10},{0,70,35,15,110},{0,50,105,125,110},
                                        {0,110,135,50,65},{0,65,75,5,70},{0,10,85,130,30},{0,105,35,10,15}};
 ...
 public static final int[][] REPARTITION_DES_RACES={{0,80,90,140},{0,40,50,90},{100,140,50,90},{0,50,0,50},
  ...
  // Les r�partitions initiales des races(miny,maxy,minx,maxx).
  // La r�partition se fait en surfaces rectangulaires homog�nes.

 public static final int NB_RACES_PAR_GALAXIE=8;
  // Il y a obligatoirement 5 races diff�rentes par galaxie.

 public static final int NB_RACES=Messages.RACES.length;
  // Le nombre de races diff�rentes.

 public static final int TAILLE_MAX_DE_PLANETE=5;
  // La taille d'une plan�te va de 1 au max.

 public static final int TYPE_MAX_DE_PLANETE=19;
  // Le type d'une plan�te va de 0 au max.

 public static final int PRODUCTION_MINERAI_MAX=8;
  // La production "de base" d'une plan�te va de 0 au max.
 ...
 //le nombre de sortes de missions possibles pour les services sp�ciaux.
 ...
 //Les diff�rents champs de budget de syst�me.
 ...
 //le nombre de domaines diff�rents dans l'affectation du budget.

 public static final int TAXATION_MAXIMALE=5;
 //le taux d'imp�ts le plus �lev� possible.

 public static final float COUT_TERRAFORMATION=10F;
 //Le cout de terraformation par niveau pour une plan�te.
 ...
 //Les caract�risations des diff�rents types de composant de vaisseau.

 public static final String CV_ARME_CS="combat spatial";
 public static final String CV_ARME_M="mixte";
 public static final String CV_ARME_CP="combat plan�taire";
 //Les caract�risations des diff�rents types d'armes.
 ...
 public static final int MODIFICATEUR_MULTIPLICATEUR_CREATION=5;
  //Le modificateur multiplicateur du prix n�cessaire pour cr�er un plan de vaisseau.
 ...
 //Les diff�rents co�ts de cr�ation d'alliance.
 ...
 //Les diff�rents types d'alliance.
 ...
 //la barri�re au-del� de laquelle un don classique devient publique.
 ...
 //Le pourcentage de chance que le don de strat�gie en mode normal devienne public.
 ...
 //Le nombre maximal de technologies que le joueur peut rechercher en m�me temps.

 public static final int MORAL_DEPART_EQUIPAGE=4500;
 //la caract�ristique moral de l'�quipage d'un vaisseau lors de sa cr�ation.
 ...
 //les diff�rents �l�ments agissant sur la relation entre les races.
 ...
 public static final int POLITIQUE_ANTI_EDHEL=9;
 public static final int POLITIQUE_ANTI_TOROK=10;
 public static final int POLITIQUE_ANTI_SHINARII=11;
 public static final int POLITIQUE_ANTI_MORGLORH=12;
 public static final int POLITIQUE_ANTI_SYLTAAR=13;
 public static final int POLITIQUE_ANTI_ARACHNOR=14;
 ...
 //Les diff�rents produits commerciaux.
 ...
 public static final int BUDGET_REVENUS_MARCHANDAGE_HEROS=13; //concerne l'apport financier correspodant au marchandage du h�ros
 ...
 //Les diff�rents champs du budget.
 ...
 public static final int COMPOSANT_CAPACITE_BOUCLIER_MAGNETIQUE=3;
 public static final int COMPOSANT_CAPACITE_LANCEUR_MINES_CLASSIQUES=4;
 public static final int COMPOSANT_CAPACITE_DETECTION_MINES=5;
 public static final int COMPOSANT_CAPACITE_NAVIRE_USINE=6;     //###############
 public static final int COMPOSANT_BROUILLAGE_RADAR=7;
 public static final int COMPOSANT_CAPACITE_RAYON_TRACTEUR=8;
 public static final int COMPOSANT_CAPACITE_CONTENANCE_CARGO=9;
 public static final int COMPOSANT_CAPACITE_VILLE_SPATIALE=10;
 public static final int COMPOSANT_CAPACITE_COLONISATEUR=11;
 public static final int COMPOSANT_PORTEE_SCANNER_FLOTTE=12;
 public static final int COMPOSANT_DRAGUEUR_MINES=13;
...
// public static final int BATIMENT_CAPACITE_MODIFICATION_GRAVITE=10; //############ 
 //les diff�rentes caract�ristiques sp�ciales.
 ...
 public static final float COUT_REPARATION_VAISSEAU=0.5F;
  //Le c�ut de r�paration d'un point de dommage pour un vaisseau.
 public static final int POINTS_REPARATION_BATIMENT=5;
  //Le nombre de points de r�paration d'un b�timent par tour.
 ...
 //les diff�rentes caract�ristiques des composants armes.

 public static final int PUISSANCE_ATTAQUE_PLANETAIRE_MINIMALE=35;
 //puissance minimale requise pour attaquer une plan�te.
 ...
 //Les codes pour les diff�rents types de transport.
 ...
 //les diff�rentes comp�tences de leader.

 public static final int NOMBRE_COMPETENCES=Messages.COMPETENCES_LEADER.length;
 //Le nombre de comp�tences diff�rentes pour un leader.
 ...
 //la valeur d'un point de caract�ristique,d'une comp�tence sp�ciale,ou d'une comp�tence normale d'un leader.
 ...
 //les diff�rentes possibilit�s d'augmentation de caract�ristique pour un leader par rapport � sa race.
 ...
 //les diff�rentes possibilit�s de r�partition de comp�tence pour un h�ros par rapport � sa race.
 ...
 //les diff�rentes possibilit�s de r�partition de comp�tence pour un gouverneur par rapport � sa race.
 ...
 //les types de d�bris(les mines intelligentes sont d�sign�es par le num�ro de leur joueur).

 public static final int[][] HABITAT_RADIATION={ {1,85},{0,150},{1,95},{5,75},{1,120},
                                                 {50,200},{0,200},{10,160}
                                                 };
 public static final int[][] HABITAT_TEMPERATURE={ {-80,70},{-40,60},{-90,60},{-60,100},{-50,120},
                                                   {-120,150},{-150,200},{-100,150}
                                                    };
 public static final int[][] HABITAT_GRAVITE={ {1,40},{0,35},{15,85},{1,45},{5,55},
                                               {1,60},{0,100},{10,90}
                                                };
  //Les conditions support�es par les diff�rentes races(min et max).

 public static final int[][] RACES_ATMOSPHERES={ 
                                        {2,1,0,-1,-2},{3,2,0,-2,-3},{1,0,0,0,-1},{3,2,1,-2,-2},{-1,0,2,0,-1},
                                        {-2,-1,0,1,2},{-2,-2,0,1,1},{1,0,-2,0,1}
  };
  // Le modificateur de progression de population suivant la race et le type d'atmosph�re.

 public static final int[][] RACES_CARACTERISTIQUES={
  {0,0,0,0,0,0},{-2,0,-5,10,0,0},{-5,10,3,-5,-3,3},{0,-5,0,5,3,-3},{4,-10,10,0,-6,0},
  {8,0,-10,-10,7,0},{1,5,0,-5,-2,0},{0,0,0,0,0,0}
  };
 ...
 public static final int RACE_CARACTERISTIQUE_BONUS_SERVICE_SPECIAUX=4;         //##########
 ...
 public static final String[] RACE_TECHNOLOGIES={"raffineI","metauxI","extraI","diploI","armeI",
                                                 "pharmaI",null,null};
 // les modificateurs propres � chaque race.
 ...
 //Les diff�rents types d'agressivite.
 public static final int STRATEGIE_AGRESSIVITE_NB_MAXIMAL=STRATEGIE_AGRESSIVITE_RAGE;
 //le num�ro le plus �lev� d'agressivit�(pour v�rification des ordres);
 ...
 //Les diff�rents types de cibles possibles.
 public static final int STRATEGIE_CIBLE_NB_MAXIMAL=STRATEGIE_CIBLE_CARGO;
 //le num�ro le plus �lev� de type de cible(pour v�rification des ordres);
 ...
 //Les dimensions des deux camps lors d'un combat au d�part.
...
/* public static final int[][] TAILLE_VAISSEAUX={{1,2,9},{3,4,8},{5,8,7},{9,20,6},{21,50,5},
 ...
 //la base pour calculer le niveau d'exp�rience.
...
// public static final int CHANCE_EXPLOSION_MOTEUR=1; -- Origin
 ...
 public static final int NOMBRE_SALVE_BATTERIE=100;
  //le nombre de tirs par batterie de d�fense plan�taire.

 public static float COUT_CHANGER_CAPITALE=100F;
  //Le co�t d'un changement de capitale.

 public static int[][] MODIFICATEUR_STABILITE_CAPITALE={{0,3},{1,2},{2,1},{6,0},{8,-1},{11,-3},{Integer.MAX_VALUE,-8}};
  //Les modificateurs de stabilit� en fonction de la distance par rapport � la capitale.
 public static int[] MODIFICATEUR_STABILITE_TAXATION={6,3,0,-3,-7,-12};
  //Les modificateurs de stabilit� en fonction de la taxation de la plan�te.


 public static float COUT_CHANGER_POLITIQUE=30F;
  //Le co�t d'un changement de politique.
 ...
 public static final String[] NOMS_TABLES_ORDRES={
  ...
  "utiliser_colonisateur","larguer_mines","construire_flotte","utiliser_porte_galactique",
  "utiliser_porte_intragalactique","diviser_flotte","deplacer_flotte","pister",
  "fusionner_flotte",
 ...
 //Les diff�rentes tables o� sont stock�es les donn�es n�cessaires aux ordres.
 ...
 //Les messages syst�mes lors de la gestion d'un univers.
